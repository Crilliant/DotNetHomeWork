       ...
       static public List<Customer> CustomerList { get; set; }=new List<Customer>();
        ...
        private void InitialForm()
        {
            if (EditModel)//修改
            {
                ...
                cbb_customer_value.SelectedItem= CurrentOrder.customer;
                cbb_customer_value.Enabled = false;
            }
            else
            {
                ...
                {
                    int No = context.Orders.ToList().Count+1;
                    lbl_orderID_value.Text = No.ToString();
                }               
            }
        ...
        private void cbb_customer_value_SelectedIndexChanged(object sender, EventArgs e)
        {
